...
public class ReflectionHelper {
    ...
    public static void setFieldValue(final Object target, final String obfName, final String deobfName, Object value)
    {
        ...
        for(Class<?> cls1 = cls; cls1 != null; cls1 = cls1.getSuperclass())
        {
            ...
            {
                throw new RuntimeException("Error setting reflected field value: " + deobfName + "/" + obfName + " @" + target.getClass().getSimpleName());
            }
        }
